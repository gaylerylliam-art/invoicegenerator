...
def main():
    ...
    with col2:
        ...
        preview_html = (
            ...
            f'<div style="text-align: right; display: flex; flex-direction: column; align-items: flex-end;">'
            f'<h1 style="margin: 0; font-size: 4em; font-weight: 1000; color: #000; line-height: 0.8; letter-spacing: -2px;">INVOICE</h1>'
            f'<div style="margin-top: 20px; font-size: 1em; color: #333; text-align: right;">'
            f'<div style="display: flex; justify-content: flex-end; margin-bottom: 3px;"><span style="font-weight: bold; margin-right: 10px;">Invoice #:</span><span>{st.session_state.invoice_data["invoice_number"]}</span></div>'
            f'<div style="display: flex; justify-content: flex-end;"><span style="font-weight: bold; margin-right: 10px;">Date:</span><span>{st.session_state.invoice_data["date"]}</span></div></div></div></div>'
            f'<hr style="border: 0; border-top: 3px solid #000; margin: 40px 0;">'
